...
export function Vehicle({
  ...
  const wheelInfo1 = { ...wheelInfo, isFrontWheel: true, frictionSlip: 5.5, chassisConnectionPointLocal: [-width / 2, height, front] as [number, number, number] };
  const wheelInfo2 = { ...wheelInfo, isFrontWheel: true, frictionSlip: 5.5, chassisConnectionPointLocal: [width / 2, height, front] as [number, number, number] };
  const wheelInfo3 = { ...wheelInfo, isFrontWheel: false, frictionSlip: 3.5, chassisConnectionPointLocal: [-width / 2, height, back] as [number, number, number] };
  const wheelInfo4 = { ...wheelInfo, isFrontWheel: false, frictionSlip: 3.5, chassisConnectionPointLocal: [width / 2, height, back] as [number, number, number] };
  ...
  useFrame((state) => {
    ...
    const engineForce = isActive ? (forward ? -force : backward ? force : 0) : 0;
